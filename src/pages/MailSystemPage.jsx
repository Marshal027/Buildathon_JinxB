            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex justify-between items-start pb-4 border-b border-white/5 shrink-0">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${getSenderAvatarColor(selectedEmail.senderRole)} flex items-center justify-center font-bold text-xs uppercase shadow-inner`}>
                    {selectedEmail.sender.slice(0, 2)}
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="text-sm font-bold text-white">{selectedEmail.sender}</h3>
                      <span className="text-[10px] bg-white/10 px-1.5 py-0.5 rounded text-[#cac5cc]/60 capitalize">{selectedEmail.senderRole}</span>
                    </div>
